...
public class StudentLeave extends JFrame implements ActionListener{
    ...
    JDateChooser studentleavedate;
    JButton submit, cancel; 
    JTextField leavereasion;
    StudentLeave(){
        super("Student Leave Details");
        setLayout(null);
        ...
        JLabel registrationnumber = new JLabel("Student Registration Number ");
        ...
        try{
            Conn conn = new Conn();            
            ResultSet regno = conn.s.executeQuery("select * from tbl_student");
            while(regno.next()){
        ...
        add(leavedate);        
        studentleavedate = new JDateChooser();
        studentleavedate.setBounds(250,160, 200 , 25);
        add(studentleavedate);
    ...
    public void actionPerformed(ActionEvent actionevent){
        if(actionevent.getSource() == submit){
             ...
             String date = ((JTextField) studentleavedate.getDateEditor().getUiComponent()).getText();
             String duration =  leavetimeduration.getSelectedItem();
             String reasion = leavereasion.getText();
             String query =  "insert into tbl_studentleave values('"+registrationnumber+"','"+date+"','"+duration+"','"+reasion+"')";
